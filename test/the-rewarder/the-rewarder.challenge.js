...
describe("[Challenge] The rewarder", function () {
  ...
  it("Execution", async function () {
    ...
    // Increase of 5 days to meet the reward pool requirement
    time.increase(432000);

    let attacker_contract = await ethers.getContractFactory(
      "Attacker_the_rewarder",
      player
    );
    let attacker = await attacker_contract.deploy(
    ...
    let connected_attacker = await attacker.connect(player);
    await connected_attacker.attack();
  });
